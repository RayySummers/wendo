  ...
  return (
    <html lang="zh-CN" data-theme="dark" suppressHydrationWarning>
      <head>
        ...
        <link rel="preconnect" href="https://cdn.font.im" crossOrigin="anonymous" />
        <link href="https://fonts.font.im/css2?family=Newsreader:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=Noto+Sans+SC:wght@400;500;700&family=Noto+Serif+SC:wght@400;500;600;700&display=swap" rel="stylesheet" />
      </head>
      <body>
        <LenisProvider>
          <Navbar />
